...
function makeData(): LedgerData {
  return {
    ...
    categories: [
      { id: 10, name: 'Groceries', group_id: 1, sort_order: 1, color: '#aaa', exclude_from_discretionary: 0 },
      { id: 20, name: 'Nicotine', group_id: 2, sort_order: 2, color: '#bbb', exclude_from_discretionary: 0 },
    ],
    entries: [
